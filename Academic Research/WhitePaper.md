...
Weight decay and momentum functionalities were added to the SGD-Upd algorithm and weight decay was added to the 
...
*Table 4: Best runs for optimizers using Resnet9 and CIFAR-100.*
